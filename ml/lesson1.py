#Naive Bayes Sınıflandırma Alg. %82,96 Doğruluk Değeri
...
# Naive Bayes Sınıflandırma Alg. Kod Sonu


# Decision Tree Sınıflandırma Alg. %95,26 Doğruluk Değeri (Kod Başlangıcı)
import numpy as np
import pandas as pd
